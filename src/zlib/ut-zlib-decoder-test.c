...
int main(int argc, char **argv) {
  UtObjectRef empty_data = ut_uint8_list_new_with_elements(
  ...
  UtObjectRef single_data = ut_uint8_list_new_with_elements(
  ...
  UtObjectRef hello_data =
      ut_uint8_list_new_with_elements(13, 0x78, 0x9c, 0xcb, 0x48, 0xcd, 0xc9, 0xc9,
