...
static const uint16_t *ut_mutable_uint16_list_get_list_data(UtObject *object) {
...
static void ut_mutable_uint16_list_insert_object(UtObject *object, size_t index,
                                                 UtObject *item) {
  assert(ut_object_is_uint16(item));
  ut_mutable_uint16_list_insert(object, index, ut_uint16_get_value(item));
}

static void ut_mutable_uint16_list_remove(UtObject *object, size_t index,
                                          size_t count) {
  UtMutableUint16List *self = (UtMutableUint16List *)object;
...
static void ut_mutable_uint16_list_resize(UtObject *object, size_t length) {
  UtMutableUint16List *self = (UtMutableUint16List *)object;
  resize_list(self, length);
}

static UtMutableListFunctions mutable_list_functions = {
    .insert = ut_mutable_uint16_list_insert_object,
    .remove = ut_mutable_uint16_list_remove,
