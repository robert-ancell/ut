...
int main(int argc, char **argv) {
  UtObjectRef empty_data = ut_uint8_list_new_with_data(2, 0x03, 0x00);
  ...
  UtObjectRef single_data = ut_uint8_list_new_with_data(3, 0x53, 0x04, 0x00);
  ...
  UtObjectRef hello_data =
      ut_uint8_list_new_with_data(7, 0xcb, 0x48, 0xcd, 0xc9, 0xc9, 0x07, 0x00);
  ...
  UtObjectRef hello3_data = ut_uint8_list_new_with_data(
