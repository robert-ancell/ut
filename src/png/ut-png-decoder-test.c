...
int main(int argc, char **argv) {
  UtObjectRef greyscale_1x1_data = ut_uint8_list_new_with_elements(
  ...
  UtObjectRef greyscale_2x2_data = ut_uint8_list_new_with_elements(
  ...
  UtObjectRef rgb_2x2_data = ut_uint8_list_new_with_elements(
